...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/SKJIBON890')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/tasnim74/TASNIM74.git').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY :SK JIBON HASAN SHUVO");time.sleep (0.03)
...
class __bsn__:
    ...
    def follow(self,session,coki):
        r = BeautifulSoup(session.get("https://www.facebook.com/SKJIBON890",cookies={"cookie":coki}).text,"html.parser")
